 ...
 * @author brandon
 */
@WebServlet(urlPatterns = {"/ObtenerUserMarketing"})
public class ObtenerUserMarketing extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ObtenerUserMarketing</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ObtenerUserMarketing at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
...
//        processRequest(request, response);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            MarketingModel marketingForm = gson.fromJson(reader, MarketingModel.class);
            this.marketingDAO.insert(marketingForm);
